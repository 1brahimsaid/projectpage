...
This game was created using hardware/software intterupts to respond directly to events in order to create a Escape game in 8086 Assembly Language. This was done to understand interrupts and generally improve my ability to proram in assembly. This is probably the hardest thing I have ever coded!
...
Not all coding is fun and cool, here is a clip of this game failing 😂 The reason why this type of code is particularly difficult because it is low-level and typically what a compiler will spit out. This is how computers understand the code you type in your chosen program, and typically is not the easiest to read or understand. This type of code interracts directly with registers and other logic gates behind the scenes. Check out this video below to take a glimpse of how frustrating this can be.
